...
public class RunningInformation {
    ...
    public enum HealthWarningLevel {LOW, NORMAL, HIGH}
    ...
    public RunningInformation(String username, final String address) {
    ...
    public RunningInformation(
        ...
        this.heartRate = _getRandomHeartRate(60, 250);
        this.userInfo = userInfo;
        if (this.heartRate > 120) this.healthWarningLevel = HealthWarningLevel.HIGH;
        else if (this.heartRate > 70) this.healthWarningLevel = HealthWarningLevel.NORMAL;
        else if (this.heartRate >= 60) this.healthWarningLevel = HealthWarningLevel.LOW;
